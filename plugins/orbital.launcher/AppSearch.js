// Ported verbatim from /usr/share/omarchy/shell/services/AppSearch.js — the
// exact fuzzy-search/sort algorithm first-party AppLibrary.sortedEntries()
// itself runs on top of DesktopEntries. Used here as the direct fallback
// when shell.appLibrary isn't available (see Launcher.qml's header comment
// for why that happens for an overlay/menu-kind plugin, and why community
// launchers such as maajix/omarchy-spotlight build the exact same fallback
// rather than treating appLibrary as guaranteed).
